...
public class AlbumDua extends AppCompatActivity {
...
//    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.album_dua);
...
//        toolbar.setNavigationIcon(R.drawable.gress);
    ...
    private void populateRecyclerView() {
        ...
        lisner.addOnItemTouchListener(new RecyclerOnClick(this, new RecyclerOnClick.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                startActivity(new Intent(AlbumDua.this, AlbumPemutarYoutube.class)
    ...
    private ArrayList<ItemList> generateDummyVideoList() {
        ...
        String[] videoIDArray = getResources().getStringArray(R.array.link_video_dua);
        String[] videoTitleArray = getResources().getStringArray(R.array.judul_lagu_dua);
        String[] videoDurationArray = getResources().getStringArray(R.array.waktu_video_dua);
