...
public class AlbumDelapan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.album_delapan);
    ...
    private void populateRecyclerView() {
        ...
        lisner.addOnItemTouchListener(new RecyclerOnClick(this, new RecyclerOnClick.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                startActivity(new Intent(AlbumDelapan.this, AlbumPemutarYoutube.class)
