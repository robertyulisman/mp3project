...
public class Albumtujuh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.album_tujuh);
    ...
    private void populateRecyclerView() {
        ...
        lisner.addOnItemTouchListener(new RecyclerOnClick(this, new RecyclerOnClick.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                startActivity(new Intent(Albumtujuh.this, AlbumPemutarYoutube.class)
