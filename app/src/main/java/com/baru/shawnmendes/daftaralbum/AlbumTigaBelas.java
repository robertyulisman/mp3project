...
public class AlbumTigaBelas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.album_tiga_belas);
    ...
    private void populateRecyclerView() {
        ...
        lisner.addOnItemTouchListener(new RecyclerOnClick(this, new RecyclerOnClick.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                startActivity(new Intent(AlbumTigaBelas.this, AlbumPemutarYoutube.class)
