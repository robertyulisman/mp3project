...
public class AlbumTiga extends AppCompatActivity {
...
//    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.album_tiga);
...
//        });
    ...
    private void populateRecyclerView() {
        ...
        lisner.addOnItemTouchListener(new RecyclerOnClick(this, new RecyclerOnClick.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                startActivity(new Intent(AlbumTiga.this, AlbumPemutarYoutube.class)
    ...
    private ArrayList<ItemList> generateDummyVideoList() {
        ...
        String[] videoIDArray = getResources().getStringArray(R.array.link_video_tiga);
        String[] videoTitleArray = getResources().getStringArray(R.array.judul_lagu_tiga);
        String[] videoDurationArray = getResources().getStringArray(R.array.waktu_video_tiga);
