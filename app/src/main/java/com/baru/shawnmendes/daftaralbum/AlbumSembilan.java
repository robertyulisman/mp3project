...
public class AlbumSembilan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.album_sembilan);
    ...
    private void populateRecyclerView() {
        ...
        lisner.addOnItemTouchListener(new RecyclerOnClick(this, new RecyclerOnClick.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                startActivity(new Intent(AlbumSembilan.this, AlbumPemutarYoutube.class)
